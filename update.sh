...
function_verify () {
  permited=$(curl -sSL "https://raw.githubusercontent.com/AAAAAEXQOSyIpN2JZ0ehUM/PROYECTOS_DESCONTINUADOS/master/NEW-ULTIMATE-VPS-MX-8.0/_%24_Versiones/Bot_Telegram/TeleBotGen/TeleBotGen-master/Control-Bot")
