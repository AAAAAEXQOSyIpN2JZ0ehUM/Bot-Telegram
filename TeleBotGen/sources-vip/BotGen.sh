...
function_verify () {
  permited=$(curl -sSL "https://raw.githubusercontent.com/AAAAAEXQOSyIpN2JZ0ehUM/Bot-Telegram/main/TeleBotGen/Control/Control-Bot")
...
[[ ! -e "/bin/ShellBot.sh" ]] && wget -O /bin/ShellBot.sh https://raw.githubusercontent.com/AAAAAEXQOSyIpN2JZ0ehUM/Bot-Telegram/main/ShellBot.sh &> /dev/null
